document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      const existingErrorClasses = contactForm.querySelectorAll('.error');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Mr Lorax משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'e0829453-aa56-47ac-bfee-f512e467c2f4',
                    name: data.name || '',
                    email: data.email || '',
